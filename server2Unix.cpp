...
int main() {
    ...
    while(bytes_sent1<0) {
        ...
        int byets_received1;
        do{
        byets_received1 = recv(server_socket, validation, sizeof(validation), 0);
        if (byets_received1 <1) {
            ...
            int lmao;
            string my_string(validation);
            lmao= strcmp(validation,"Registration Completed Successfully");
